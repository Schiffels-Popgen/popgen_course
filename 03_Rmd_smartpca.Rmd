...
snps <- readr::read_delim(
   "data/popgen_course/HumanOrigins_FennoScandian_small.snp", 
   delim = " ", 
   trim_ws = T,
   col_names = c(
      "SNP_name", 
...
geno <- readr::read_lines(
   "data/popgen_course/HumanOrigins_FennoScandian_small.geno",
   n_max = 20
)
...
```{r}
R.utils::countLines("data/popgen_course/HumanOrigins_FennoScandian_small.geno")
```
